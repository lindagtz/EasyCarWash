                ...
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem item) {
                        ...
                        if (id == R.id.nav_home) {
                            ...
                            fragmentManager.beginTransaction().replace(R.id.content_navi_drawer, fragmentWelcome).commit();

                        } else if (id == R.id.nav_about) {
                            // Log.i("hola", "hi");
                            Acercade acercade=new Acercade();
                            fragmentManager.beginTransaction().replace(R.id.content_navi_drawer, acercade).commit();
                        }
                        else if (id == R.id.nav_perfil) {
                           // Log.i("hola", "hi");
                            Perfi perfi=new Perfi();
                            fragmentManager.beginTransaction().replace(R.id.content_navi_drawer, perfi).commit();
